...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("C an S Employees");
            ...
            {
                Console.WriteLine($"Age: {person.Age} Fullname: {person.FullName} Years: {person.YearsOfExperience}");
            }
            ...
            employees = employees.Append(new Employee("first", "lastName", 23, 45)).ToList();
